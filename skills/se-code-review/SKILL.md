...
- `docs/brainstorms/*` -- requirements documents created by se-brainstorm
- `docs/plans/*.md` -- plan files created by se-plan (decision artifacts; execution progress is derived from git, not stored in plan bodies)
