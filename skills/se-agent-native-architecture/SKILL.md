...
| 2, "files", "workspace", "filesystem" | Read `references/files-universal-interface.md` and `references/shared-workspase-architecture.md` |
...
- `references/shared-workspase-architecture.md` - Shared data space, UI integration
