# Software Engineering Feedback Format
...
-> /se-brainstorm to confirm, correct, and regroup the captured requirements before any planning.
```
...
- Do not include absolute local paths in SE docs; use repo-relative paths when possible.
