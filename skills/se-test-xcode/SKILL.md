...
/se-test-xcode MyApp-Debug

# Test after making changes
/se-test-xcode current
```

## Integration with se-code-review

When reviewing PRs that touch iOS code, the `se-code-review` workflow can spawn an agent to run this skill, build on the simulator, test key screens, and check for crashes.
