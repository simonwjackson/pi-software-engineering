#!/usr/bin/env python3
"""
list-plugin-releases.py — Fetch software-engineering plugin releases from GitHub.
...
Environment:
  SE_RELEASE_NOTES_GH_BIN  Override the gh binary path (default: "gh"). Used
...
OWNER = "EveryInc"
REPO = "software-engineering-plugin"
TAG_PREFIX = "software-engineering-v"
...
def attempt_gh(limit):
    ...
    """
    gh_bin = os.environ.get("SE_RELEASE_NOTES_GH_BIN", "gh")
...
def attempt_anon(limit, api_base):
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "se-release-notes-skill",
        },
    )
    try:
...
def main():
    parser = argparse.ArgumentParser(
        description="Fetch software-engineering plugin releases from GitHub."
    )
    parser.add_argument(
        "--limit",
        type=int,
