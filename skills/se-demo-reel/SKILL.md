...
compatibility: npm, python3, vhs, ffmpeg
---
...
- **No evidence needed** -> Skip to output. Set `evidense_url` to null, `evidense_label` to null.
...
- The caller applies the label when formatting. se-demo-reel does not generate markdown.
