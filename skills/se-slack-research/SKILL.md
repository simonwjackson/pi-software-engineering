...
```
/se-slack-research [topic or question]
/se-slack-research
```
...
```
/se-slack-research free trial
/se-slack-research What did we say about free trial recently?
/se-slack-research free trial in #proj-reverse-trial
/se-slack-research onboarding flow after:2026-03-01
```
...
Dispatch `se-slack-researcher` with the user's topic as the task prompt. Omit the `mode` parameter so the user's configured permission settings apply.
