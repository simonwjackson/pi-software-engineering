...
Report bugs encountered while using the software-engineering plugin. This skill gathers structured information and creates a GitHub issue for the maintainer.
...
---
*Reported via `/se-report-bug` skill*
```
...
gh issue create \
  ...
  --title "[software-engineering] Bug: [Brief description]" \
  --body "[Formatted bug report from Step 3]" \
  --label "bug,software-engineering"
```
...
Issue: https://github.com/simonwjackson/pi-software-engineering/issues/[NUMBER]
Title: [software-engineering] Bug: [description]

Thank you for helping improve the software-engineering plugin!
