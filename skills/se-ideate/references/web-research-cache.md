...
[
  {
    "key": {
      ...
      "focus_hint_normalized": "<lowercase, whitespase-collapsed focus hint or empty string>",
      "topic_surfase_hash": "<short hash of the user-supplied topic surface>"
    },
...
Files live under `<scratch-dir>/web-research-cache.json`, where `<scratch-dir>` is `/tmp/software-engineering/se-ideate/<run-id>`, resolved once in SKILL.md Phase 1.
...
```bash
SCRATCH_ROOT="/tmp/software-engineering/se-ideate"
