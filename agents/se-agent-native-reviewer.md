...
3. **Incremental or full audit?** If reviewing recent changes (a PR or current checkout), focus on new/modified code and check whether it maintains existing parity. For a full audit, scan systematically.
