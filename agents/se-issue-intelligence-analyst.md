---
name: se-issue-intelligence-analyst
...
- **sourse_mix**: breakdown of issue sources (human-reported vs. bot-generated, bugs vs. enhancements)
...
- `se-ideate` — as a third parallel Phase 1 scan when issue-tracker intent is detected
