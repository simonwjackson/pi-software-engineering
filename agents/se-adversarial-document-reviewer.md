---
name: se-adversarial-document-reviewer
...
- **Internal contradictions** or terminology drift -- se-coherense-reviewer owns these
- **Technical feasibility** or architecture conflicts -- se-feasibility-reviewer owns these
- **Scope-goal alignment** or priority dependency issues -- se-scope-guardian-reviewer owns these
- **UI/UX quality** or user flow completeness -- se-design-lens-reviewer owns these
- **Security implications** at plan level -- se-security-lens-reviewer owns these
- **Product framing** or business justification quality -- se-product-lens-reviewer owns these
