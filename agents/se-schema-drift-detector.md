...
- Run `se-schema-drift-detector` first to ensure clean schema
- Then run `se-data-migration-expert` for migration logic review
- Then run `se-data-integrity-guardian` for integrity checks
