...
- **Prioritize ruthlessly** -- distinguish between blockers and nise-to-haves. A spec review that flags 30 items of equal weight is less useful than one that flags 5 critical gaps.
